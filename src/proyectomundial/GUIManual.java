...
public class GUIManual extends JFrame {
    ...
    private JPanel jPanelIniciarSesion;
    private JLabel btnIniciarSesion;
    private JLabel btnllamaLogin;
    ...
    private void initComponents() {
        ...
        jPanelIniciarSesion = new JPanel();
...
/*
    private void pintarMenuIniciarSesion() {
        btnIniciarSesion.setIcon(new ImageIcon(getClass().getResource("/resources/icons/home.png"))); // NOI18N
        btnIniciarSesion.setText("Iniciar Sesion");
        btnIniciarSesion.setForeground(new java.awt.Color(255, 255, 255));

        JLabel vacioIniciarSesion = new JLabel();
        jPanelIniciarSesion.setBackground(new java.awt.Color(17, 41, 63));
        jPanelIniciarSesion.setPreferredSize((new java.awt.Dimension(220, 35)));
        jPanelIniciarSesion.setLayout(new BorderLayout(15, 0));
        jPanelIniciarSesion.add(vacioIniciarSesion, BorderLayout.WEST);
        jPanelIniciarSesion.add(btnIniciarSesion, BorderLayout.CENTER);
        jPanelMenu.add(jPanelIniciarSesion);
...
//
    ...
    private void accionLogin() {
        ...
        Login.setText("Ingrese usuario");
        JTextArea usuario = new JTextArea();
        JLabel Login2 = new JLabel();
        Login.setText("Ingrese contraseña");
        JTextArea contraseña = new JTextArea();
        JLabel btnllamaLogin = new JLabel();
        btnllamaLogin.setSize(80, 50);
        btnllamaLogin.setText("Ingresa");
        LoginPanel.add(Login, usuario);
        LoginPanel.add(Login2, contraseña);
        LoginPanel.add(btnllamaLogin);
        jPanelMain.add(LoginPanel, BorderLayout.CENTER);
        btnllamaLogin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                System.out.println("Ingresar");
                comprobarSesion(usuario, contraseña);
            }
        });
        jPanelMain.repaint();
        jPanelMain.revalidate();
...
*/
    ...
    public void comprobarSesion() {
        ...
        if(login.consultarLogin(usuario, contraseña) == true){
            haySesion = true;
        };
    }
